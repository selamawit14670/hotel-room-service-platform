...
export default function BusinessImpact() {
  ...
  return (
    <section className="relative py-12 md:py-24 bg-black overflow-hidden" id="business-impact">
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[700px] h-[700px] bg-slate-950/20 rounded-full blur-[140px] pointer-events-none"></div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch mb-16">
          ...
          {/* Controls Column */}
          <div className="lg:col-span-5 rounded-2xl bg-[#090b11] border border-slate-900 p-6 flex flex-col justify-between">
            <div>
              <h3 className="text-sm font-bold text-slate-200 uppercase font-mono tracking-wider mb-6 border-b border-slate-800 pb-3 flex items-center gap-2">
              ...
              <div className="space-y-6">
                ...
                <div>
                  <div className="flex justify-between items-center text-xs mb-2">
                    <span className="text-slate-400 font-medium">Hotel Key Count (Rooms):</span>
                  ...
                  <input 
                    ...
                    className="w-full accent-luxury-gold bg-slate-950 rounded-lg cursor-pointer h-1.5"
                  />
                </div>
                ...
                <div>
                  <div className="flex justify-between items-center text-xs mb-2">
                    <span className="text-slate-400 font-medium">Average Order Spend:</span>
                ...
                <div>
                  <div className="flex justify-between items-center text-xs mb-2">
                    <span className="text-slate-400 font-medium">Orders Placed Per Day:</span>
            ...
            <div className="mt-8 p-3.5 bg-black/60 border border-slate-950 rounded-xl text-[10px] text-slate-500 font-mono leading-relaxed">
          ...
          <div className="lg:col-span-7 grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div className="p-6 rounded-2xl bg-[#090b11] border border-slate-900 flex flex-col justify-between hover:border-luxury-gold/25 transition-colors">
              <div>
                ...
                <span className="text-[10px] uppercase font-mono tracking-widest text-slate-500 block">Annual Dining Surge</span>
                <h4 className="text-2xl sm:text-3xl font-bold text-slate-100 font-display mt-1">
            ...
            {/* Saved labor hours */}
            <div className="p-6 rounded-2xl bg-[#090b11] border border-slate-900 flex flex-col justify-between hover:border-slate-800 transition-colors">
              <div>
                ...
                <span className="text-[10px] uppercase font-mono tracking-widest text-slate-500 block">Saved Operation Hours</span>
                <h4 className="text-2xl sm:text-3xl font-bold text-slate-100 font-display mt-1">
                  {monthlySavedHours.toFixed(0)} Hours Saved
                </h4>
              </div>
              <p className="text-xs text-slate-400 mt-4 leading-normal font-sans">
                A massive <b className="text-orange-400">52% recovery of work</b> for front-desk receptionists and kitchen coordinators by automating order intake routines.
              </p>
            </div>
            ...
            <div className="p-6 rounded-2xl bg-[#090b11] border border-slate-900 flex flex-col justify-between hover:border-slate-800 transition-colors">
              <div>
                ...
                <span className="text-[10px] uppercase font-mono tracking-widest text-slate-500 block">Prevented Meal Errors</span>
                <h4 className="text-2xl sm:text-3xl font-bold text-slate-100 font-display mt-1">
                  {preventedAnnualErrors.toFixed(0)} Mistakes Avoided
                </h4>
              </div>
              <p className="text-xs text-slate-400 mt-4 leading-normal font-sans">
                Frictionless option customizers bypass handwritten transcription slips, preventing returned meals by a staggering <b className="text-red-400">68% margin</b>.
              </p>
            </div>
            ...
            <div className="p-6 rounded-2xl bg-[#090b11] border border-slate-900 flex flex-col justify-between hover:border-slate-800 transition-colors">
              <div>
                ...
                <span className="text-[10px] uppercase font-mono tracking-widest text-slate-500 block">Adoption Score</span>
                <h4 className="text-2xl sm:text-3xl font-bold text-slate-100 font-display mt-1">
                  92% Staff Adoption
                </h4>
              </div>
              <p className="text-xs text-slate-400 mt-4 leading-normal font-sans">
                Highly intuitive visual interfaces require <b className="text-emerald-400">less than 15 minutes</b> of induction training for cook lists and couriers alike.
              </p>
            </div>
        ...
        <div className="p-1 px-4 rounded-3xl border border-slate-920 bg-neutral-950/20 grid grid-cols-2 md:grid-cols-5 gap-6 text-center py-8">
          {[
            ...
            <div key={i} className="space-y-1">
              <span className="text-2xl md:text-4xl font-black font-display text-transparent bg-clip-text bg-gradient-to-b from-slate-100 to-slate-400 block">{stat.metric}</span>
